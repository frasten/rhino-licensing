...
namespace Rhino.Licensing
{
    ...
    public abstract class AbstractLicenseValidator
    {
        ...
        public virtual void AssertValidLicense()
        {
            ...
            Console.WriteLine("Could not validate existing license\r\n{0}", License);
        ...
        private bool HasExistingLicense()
        {
            try
            {
                ...
                {
                    Console.WriteLine("Failed validating license:\r\n{0}", License);
                    return false;
                }
                Console.WriteLine("License expiration date is {0}", ExpirationDate);
        ...
        private bool ValidateSubscription()
        {
            ...
            {
                Console.WriteLine("Could not re-lease subscription license", e);
            }
        ...
        protected bool TryOverwritingWithNewLicense(string newLicense)
        {
            ...
            {
                Console.WriteLine("New license is not valid XML\r\n" + newLicense, e);
                return false;
            }
            License = newLicense;
            return true;
        ...
        public bool TryLoadingLicenseValuesFromValidatedXml()
        {
            try
            {
                ...
                {
                    Console.WriteLine("Could not validate xml signature of:\r\n{0}", License);
                    return false;
                }

                if (doc.FirstChild == null)
                {
                    Console.WriteLine("Could not find first child of:\r\n{0}", License);
                    return false;
                }
                ...
                if (doc.SelectSingleNode("/floating-license") != null)
                {
                    ...
                    if (node == null)
                    {
                        Console.WriteLine("Invalid license, floating license without license server public key:\r\n{0}", License);
            ...
            {
                Console.WriteLine("Could not validate license", e);
                return false;
            }
        }
        ...
        private bool ValidateFloatingLicense(string publicKeyOfFloatingLicense)
        {
            ...
            {
                Console.WriteLine("Floating licenses have been disabled");
                return false;
            }
            if (licenseServerUrl == null)
            {
                Console.WriteLine("Could not find license server url");
            ...
            try
            {
                ...
                {
                    Console.WriteLine("Null response from license server: {0}", licenseServerUrl);
                ...
                {
                    Console.WriteLine("Could not get valid license from floating license server {0}", licenseServerUrl);
                    throw new FloatingLicenseNotAvailableException();
                }
                ...
                if (validLicense)
                {
                    ...
                    Console.WriteLine("Will lease license again at {0}", time);
        ...
        internal bool ValidateXmlDocumentLicense(XmlDocument doc)
        {
            ...
            if (id == null)
            {
                Console.WriteLine("Could not find id attribute in license:\r\n{0}", License);
                return false;
            }
            ...
            if (date == null)
            {
                Console.WriteLine("Could not find expiration in license:\r\n{0}", License);
                return false;
            }
            ...
            if (licenseType == null)
            {
                Console.WriteLine("Could not find license type in {0}", licenseType);
                return false;
            }
            ...
            if (name == null)
            {
                Console.WriteLine("Could not find licensee's name in license:\r\n{0}", License);
                return false;
            }
        ...
        private bool TryGetValidDocument(string licensePublicKey, XmlDocument doc)
        {
            ...
            if (sig == null)
            {
                Console.WriteLine("Could not find this signature node on license:\r\n{0}", License);
                return false;
            }
